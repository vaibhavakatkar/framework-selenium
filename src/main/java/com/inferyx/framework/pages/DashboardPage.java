...
public class DashboardPage extends TestBase {
	...
	public void createDashboard(String dashdName, String description, String dependsOnName, String datapodName) throws InterruptedException {
		...
		filter.click();
		Thread.sleep(2000);
		getHtmlElementByXpath("/html/body/screenshot/div[4]/div[2]/div/div[4]/div/div[4]/div/div/div[2]/div/div/form/div[9]/div[1]/tags-input/div/auto-complete/div/ul/li[5]/ti-autocomplete-match/ng-include/span").click();
		Thread.sleep(2000);
		getHtmlElementByXpath("/html/body/screenshot/div[4]/div[2]/div/div[4]/div/div[4]/div/div/div[2]/div/div/form/div[9]/div[1]/tags-input/div/auto-complete/div/ul/li[7]/ti-autocomplete-match/ng-include/span").click();
		Thread.sleep(2000);
		
		
		getHtmlElementByXpath("/html/body/screenshot/div[4]/div[2]/div/div[4]/div/div[4]/div/div/div[2]/div/div/form/div[9]/label").click();
		Thread.sleep(2000);
		...
		clearFilter.click();
		*/
		WebElement nextPage = driver.findElement(By.xpath("/html/body/screenshot/div[4]/div[2]/div/div[4]/div/div[4]/div/div/div[2]/div/div/form/div[15]/div/button"));
		nextPage.click();
		Thread.sleep(4000);
