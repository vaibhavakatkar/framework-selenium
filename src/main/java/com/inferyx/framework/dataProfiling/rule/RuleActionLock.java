...
public class RuleActionLock extends TestBase{
	@BeforeMethod
	...
	public void datapodLockAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(7, 8, "Vizpod Action Lock", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(7, 8, "Vizpod Action Lock", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
