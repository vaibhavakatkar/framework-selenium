...
public class DataProfilingRuleActionViewIcon extends TestBase{
  
	@Test(priority = 20, description = "Rule Action View")
	...
	@Test(priority = 21, description = "Rule Graph")
	...
	@Test(priority = 22, description = "Rule Graph Refresh")
	...
	@Test(priority = 23, description = "Rule Home")
	...
	@Test(priority = 24, description = "Rule Edit")
	...
	@Test(priority = 25, description = "Rule Close")
