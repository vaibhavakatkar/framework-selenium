...
public class RuleActionClone extends TestBase{
	@BeforeMethod
	...
	public void ruledEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(7, 8, "Rule Action Clone", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(7, 8, "Rule Action Clone", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
