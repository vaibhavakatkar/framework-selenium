...
public class RuleActionUnlock extends TestBase{
	...
	@Test(priority =9, description = "Rule UnLock Action")
	public void datapodUnLockAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(7, 8, "Rule Action UnLock", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(7, 8, "Rule Action UnLock", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
