...
public class RuleActionUnPublish extends TestBase{
	@BeforeMethod
	...
	@Test(priority = 11, description = "Rule UnPublish Action")
	public void datapodUnPublishAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(7, 8, "Rule Action UnPublish", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(7, 8, "Rule Action UnPublish", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
