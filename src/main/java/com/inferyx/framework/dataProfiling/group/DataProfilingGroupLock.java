...
public class DataProfilingGroupLock extends TestBase{
	...
	public void groupLockAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(7, 8, "Group Action Lock", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(7, 8, "Group Action Lock", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
