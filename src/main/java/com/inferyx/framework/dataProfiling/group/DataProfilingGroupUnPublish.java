...
public class DataProfilingGroupUnPublish extends TestBase{
	...
	public void groupUnPublishAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(7, 8, "Group Action UnPublish", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(7, 8, "Group Action UnPublish", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
