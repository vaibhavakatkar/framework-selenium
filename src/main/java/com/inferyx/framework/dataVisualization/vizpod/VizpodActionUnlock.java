...
public class VizpodActionUnlock extends TestBase{
	...
	@Test(priority =14, description = "Vizpod UnLock Action")
	public void vizpodUnLockAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action UnLock", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action UnLock", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
