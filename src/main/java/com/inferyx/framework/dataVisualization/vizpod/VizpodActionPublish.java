...
public class VizpodActionPublish extends TestBase{
	...
	public void vizpodPublishAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action Publish", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action Publish", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
