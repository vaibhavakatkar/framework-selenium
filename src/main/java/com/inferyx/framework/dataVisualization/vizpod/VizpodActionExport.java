...
public class VizpodActionExport extends TestBase{
	...
	public void vizpodEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action Export", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action Export", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
