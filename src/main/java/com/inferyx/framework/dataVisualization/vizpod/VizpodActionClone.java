...
public class VizpodActionClone extends TestBase{
	...
	public void vizpodEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action Clone", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Vizpod Action Clone", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
