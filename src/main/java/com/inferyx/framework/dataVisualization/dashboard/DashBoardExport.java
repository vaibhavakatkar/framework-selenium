...
public class DashBoardExport extends TestBase{
	...
	@Test(priority = 13, description = "Dashboard Export Action")
	public void vizpodEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Dashboard Action Export", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Dashboard Action Export", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
