...
public class DashBoardRestore extends TestBase{
	...
	public void vizpodRestore() throws IOException, InterruptedException {
		...
		try {
			...
			dataFromExcelSheet.updateResult(4,5, "Dashboard Action Restore", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4,5, "Dashboard Action Restore", "FAIL", totalTime, newFile);
		}
	}
