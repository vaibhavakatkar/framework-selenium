...
public class DashBoardLock extends TestBase{
	...
	public void dashboardLockAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Dashboard Action Lock", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Dashboard Action Lock", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
