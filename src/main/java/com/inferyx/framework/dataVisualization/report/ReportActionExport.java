...
public class ReportActionExport extends TestBase{
	...
	public void vizpodEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Report Action Export", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Report Action Export", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
