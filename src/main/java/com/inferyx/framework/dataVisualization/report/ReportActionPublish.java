...
public class ReportActionPublish extends TestBase{
	...
	public void reportPublishAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Report Action Publish", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Report Action Publish", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
