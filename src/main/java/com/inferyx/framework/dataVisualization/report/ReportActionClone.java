...
public class ReportActionClone extends TestBase{
	...
	public void vizpodEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Report Action Clone", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Report Action Clone", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
