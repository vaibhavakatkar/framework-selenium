...
public class DatapodActionUnPublish extends TestBase {
	...
	public void datapodUnPublishAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action UnPublish", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action UnPublish", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
