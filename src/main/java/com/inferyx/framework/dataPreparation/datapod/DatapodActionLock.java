...
public class DatapodActionLock extends TestBase {
	...
	@Test(priority =7, description = "Datapod Lock Action")
	public void datapodLockAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action Lock", "PASS", totalTime, newFile);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action Lock", "FAIL", totalTime, newFile);
		}
		Thread.sleep(3000);
	}
