...
public class DatapodActionPublish extends TestBase {
	...
	@Test(priority = 10, description = "Datapod Publish Action")
	public void datapodPublishAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action Publish", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action Publish", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
