...
public class DatapodActionClone extends TestBase {
	...
	@Test(priority = 12, description = "Datapod Clone  Action")
	public void datapodEditAction() throws IOException, InterruptedException {
		try {
			...
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action Clone", "PASS", totalTime);
		} catch (NoSuchElementException e) {
			dataFromExcelSheet.updateResult(4, 5, "Datapod Action Clone", "FAIL", totalTime);
		}
		Thread.sleep(3000);
	}
